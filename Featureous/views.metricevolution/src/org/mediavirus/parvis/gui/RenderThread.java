...
class RenderThread extends Thread {
    ...
    synchronized void setRegion(int startAxis, int stopAxis){
        ...
        //this.ids = ids.clone();
        //OutputUtil.log("RenderThread: setting repaint axes: " + this.startAxis + ", " + this.stopAxis);
    }
        ...
        while(true){
            synchronized(this){
                ...
                do {
                    try {
                        if (! doWork){
//                            OutputUtil.log("RenderThread: waiting...");
                            this.wait();
                        }
                        //OutputUtil.log("RenderThread: exit waiting.");
                    }
                    catch (InterruptedException iex){
                        OutputUtil.log("RenderThread: interruptedExcpetion.");
            ...
            //OutputUtil.log("RenderThread: run loop start...");
            ...
            while (comp != null && progress){
                ...
                if (progressive && quality){
                    ...
                    //OutputUtil.log("RenderThread: starting progressive paint...");
                    modestr = "[quality]";
                    ...
                    //OutputUtil.log("RenderThread: starting paint...");
                    modestr = "[preview]";
                }
                ...
                for (; i<comp.getNumRecords(); i++){
                    ...
                    if ((brush == null) || (brushVal = brush.getBrushValue(i)) > 0.0f){
                        ...
                        if ((brush != null) && quality){
                            ...
                            //OutputUtil.log("Brush value: " + brushVal + " alpha: " + col.getAlpha());
                            g2.setColor(col);
                        }
                ...
                if (i==comp.getNumRecords()){
                    ...
                    //OutputUtil.log("RenderThread: paint finished...");
                    ...
                    //OutputUtil.log("RenderThread: paint interrupted...");
                    progress = false;
                    if ( secondPass ){
    ...
    synchronized void render(){
        //OutputUtil.log(this.getName() + ".render() called");
        if (this.isWorking){
            this.interrupt();
        }
        this.doWork = true;
