...
import dk.sdu.mmmi.featureous.remodularization.metrics.SDMClassCount;
...
public class SDMClassCountObjective implements RemodularizationObjectiveProvider{

    @Override
    public String getObjectiveName() {
        return "[Other] SDM class count";
    }

    @Override
    public AbstractMetric createObjective() {
        return new SDMClassCount();
    }
