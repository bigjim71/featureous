...
public class ICOMInterPackage extends AbstractMetric {

    public ICOMInterPackage() {
        super("ICOMInterPackage coupling", AbstractMetric.Scope.PACKAGE);
    }
